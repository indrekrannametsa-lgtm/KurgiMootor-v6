...
APP_PATCH_VERSION = "wd-leveldelta-production-4"  # audited RC: WIND×DRY HIGH L3–7 LEVEL+DELTA
...
if _run_operational_cycle:
    ...
    with _forecast_page_placeholder.container():
        ...
        if training_rows:
            ...
            # -------------------------------------------------------------
            _light_cache_version = "v16-light-wf-cache-wd-p3"  # WD lävendi/parity muutus: vana WF cache ei tohi üle tulla
