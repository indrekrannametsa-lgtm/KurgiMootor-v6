...
APP_PATCH_VERSION = "wd-engine-parallel-8"  # eraldi paralleelmootor; production app-128 ei muutu
APP_ICON = Image.open(APP_ICON_PATH)
st.set_page_config(page_title="KurgiMootor · WIND×DRY PARALLEEL v8", page_icon=APP_ICON, layout="wide")
...
WD_MODEL_VERSION = "wd-engine-parallel-8"
...
with _hdr_title:
    st.markdown("## KurgiMootor · WIND×DRY PARALLEEL v8")
