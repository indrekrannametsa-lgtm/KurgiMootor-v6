...
if page == "Prognoos" and not _run_operational_cycle:
    ...
    st.success("Ametlik mootor: CYCLE + WEATHER · põllupõhine tsüklitootlikkus + päris kasvutsükli ilm.")
    st.caption(
        "A+B+C kasutab külmutatud LAB44–47 arhitektuuri. XL on läbipaistev eelmise tsükli päevatootlikkuse "
        "püsivus ning C/B viimase tegeliku suhte püsivus; kumbki ei toida A+B+C mootorit tagasi."
    )
