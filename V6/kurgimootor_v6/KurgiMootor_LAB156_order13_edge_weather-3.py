# LAB-156 RH/VPD V3 — 2026-08-23 — contains sections 4 and 5
...
def main() -> None:
    ...
    st.title("Kasvu servatundide audit · RH/VPD V3")
    st.caption(
...
- tunnuste otsing on discovery. Productionit ei muudeta ja DB-sse ei kirjutata.
    ...
    cluster = ["rh_mean", "rh90_h", "vpd_mean", "lowvpd03_h", "highvpd08_h", "rain_mm", "sun_h", "dry_h", "wd_h"]
