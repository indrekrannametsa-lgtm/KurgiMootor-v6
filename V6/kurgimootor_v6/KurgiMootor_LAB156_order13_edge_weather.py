...
"""
KurgiMootor · edge_weather-24
=============================

COARSE CROP-STATE + WEATHER-DELTA TRANSITION · STRICT OOS · READ ONLY
...
def _weather_delta(target: date, weather):
    current = _weather_block(target, weather)
    previous = _weather_block(target - timedelta(days=WEATHER_BLOCK_DAYS), weather)
...
def main():
    ...
    st.caption(
        "Weather delta = T-3..T keskmine minus T-7..T-4 keskmine. Mõõdetud ilm annab mehhanismile ülemise piiri; "
