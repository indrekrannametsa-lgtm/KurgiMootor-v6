...
APP_PATCH_VERSION = "cycle-weather-production-2"  # CYCLE + WEATHER operational-weather fallback fix
...
CYCLE_MODEL_VERSION = "v6.6-cycle-weather-production-6"
...
def _ensure_active_winddry_engine() -> None:
    ...
    if _current != CYCLE_MODEL_VERSION:
        ...
        _mark_forecast_dirty("CYCLE + WEATHER korjevaba tulevikupäeva rotatsiooniparandus")
...
if page == "Mootor":
    st.subheader("Mootor")
    st.success("Aktiivne A+B+C mootor: CYCLE + WEATHER")
    st.caption(
    ...
    st.caption(
        "Ajalooline õppimine kasutab kontrollitud mõõdetud ilma. Operatiivses tulevikutsüklis "
        "kasutatakse möödunud päevadel mõõdetud ilma ja tulevastel päevadel ilmaprognoosi. "
