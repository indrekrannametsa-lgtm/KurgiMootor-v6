            ...
            if not AUTONOMOUS_DISCOVERY_ENABLED:
                ...
                for _bio_name, _bio_hyp in _bio_candidates.items():
                    if _bio_name in model_df.columns:
                        ...
                        trace_hypotheses[_bio_name] = _bio_hyp
...
if page == "Mootori tähelepanekud":
    ...
    if not _obs_ready:
        ...
        st.info(
            "🧬 **BIO kandidaatkiht aktiivne:** GDD10 · radiatsioonisumma · rad/GDD10 · "
            "hilise aja kaalutud temperatuur · hilise aja kaalutud radiatsioon."
        )
