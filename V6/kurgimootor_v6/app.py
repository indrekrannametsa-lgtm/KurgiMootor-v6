...
APP_PATCH_VERSION = "cycle-weather-production-1"  # CYCLE + WEATHER official production candidate
...
CYCLE_MODEL_VERSION = "v6.6-cycle-weather-production-2"
            ...
            for _ce_pos, f in enumerate(today_plan, start=1):
                ...
                if pred is None:
                    today_forecast_rows.append({
                        ...
                        "Alus": "CYCLE · puuduv õppimis-/ilmaandmestik", "Hinnanguline ilm": "—",
                    })
                    continue
                ...
                for target_order, f in enumerate(day_fields, start=1):
                    ...
                    if pred is None:
                        day_rows.append({
                            ...
                            "Alus": "CYCLE · puuduv õppimis-/ilmaandmestik", "Hinnanguline ilm": "puudub",
                        })
                        continue
