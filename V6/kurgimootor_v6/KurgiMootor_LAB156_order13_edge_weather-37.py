...
def main():
    ...
    st.caption('LAB-43 · same BASE · exact LAB-37 4v4 weather · new target = Δ common residual · strict walk-forward · READ ONLY')
    st.info(
    ...
    st.caption(
        ...
        'RAW SENSOR table is coefficient-free and is the primary anti-overfit check.'
    )
    st.success(
