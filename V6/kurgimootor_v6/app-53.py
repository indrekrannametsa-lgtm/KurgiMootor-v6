...
if page in ("Prognoos", "Mootori tähelepanekud"):
    ...
    with _forecast_page_placeholder.container():
        ...
        if training_rows:
            ...
            MODEL_VERSION = "v6.5-layered-bio-v3-stability"
            forecast_payloads = []
...
if page == "Mootori tähelepanekud":
    ...
    if not _obs_ready:
        ...
        st.info(
            "🧬 **V6.5 kihiline BIO aktiivne:** üksiktunnused on ainult sõel. "
            "Championiks saab ainult vähemalt kahe bioloogilise lisakihiga mudel; "
            "valik tehakse avastuses ja tõestatakse eraldi kinnituses."
        )
