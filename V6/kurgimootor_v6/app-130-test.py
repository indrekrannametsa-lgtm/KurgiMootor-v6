...
with _hdr_title:
    st.markdown("## KurgiMootor · WIND×DRY TESTMOOTOR")
    st.caption("PARALLEELTEST · uus A+B+C testmootor; production app-128 ja selle champion ei juhi seda prognoosi.")

page = st.radio(
    "Vaade",
    (["Prognoos", "Ilm"] if NEW_WD_ENGINE_TEST else ["Täna", "Korjed", "Ilm", "Prognoos", "Mootori tähelepanekud"]),
    horizontal=True,
