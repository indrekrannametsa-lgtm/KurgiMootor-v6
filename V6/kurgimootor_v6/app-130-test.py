...
APP_PATCH_VERSION = "wd-engine-test-1"  # eraldi READ-ONLY testmootor; production app-128 ei muutu
...
if NEW_WD_ENGINE_TEST:
    ...
    # Testäpp ei kirjuta Supabase'i ega käivita välisvõrgu ilmauuendust.
    for _name in (
...
with _hdr_title:
    ...
    st.caption("READ ONLY · uus A+B+C testmootor; production app-128 ja selle champion ei juhi seda prognoosi.")
...
if NEW_WD_ENGINE_TEST:
    st.info(
        ...
        "seejärel rakendub sama taimeindeks. XL ja C/B jäävad productioni eraldi mudeliteks. DB-sse ei kirjutata."
    )
