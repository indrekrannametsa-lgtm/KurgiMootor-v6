...
APP_PATCH_VERSION = "app-128-winddry-test"  # READ-ONLY test; production app-128 jääb puutumata
APP_ICON = Image.open(APP_ICON_PATH)
st.set_page_config(page_title="KurgiMootor V6.4 · WIND×DRY TEST", page_icon=APP_ICON, layout="wide")
...
st.warning(
    "🧪 WIND×DRY TEST · READ ONLY — app-128 + sama taimeindeks + üks lukustatud "
    "WIND×DRY HIGH L3–7 LEVEL+DELTA ilmakiht. DB-sse ei kirjutata."
)
        ...
        if training_rows:
            ...
            try:
                if db.yield_forecasts_available():
                    # READ-ONLY TEST: testprognoosi EI salvestata yield_forecasts tabelisse.
                    forecast_store_ok = False
                else:
