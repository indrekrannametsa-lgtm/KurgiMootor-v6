...
WD_MODEL_VERSION = "wd-engine-parallel-12"
...
with _hdr_title:
    st.markdown("## KurgiMootor · WIND×DRY PARALLEEL v10")
    st.caption("PARALLEELTEST v11 · WIND×DRY + otsene võrdlus app-128 snapshotiga.")
st.success("✅ BUILD v12 · võrdlus: 128 ABC vs WD ABC")
...
page = st.radio(
    ...
    key="wd_parallel_v10_page",
)
if NEW_WD_ENGINE_TEST:
    st.success("✅ BUILD v10 · päris WIND×DRY mudel · Prognoos arvutatakse selle lehe avamisel")
    st.info(
